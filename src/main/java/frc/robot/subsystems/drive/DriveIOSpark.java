...
/**
 * This drive implementation is for Spark devices. It defaults to brushed control, but can be easily
 * adapted for brushless motors and external encoders. Spark Flexes can be used by swapping all
